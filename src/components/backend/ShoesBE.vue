        ...
        <ul class="list" >
          <li v-for="shoe in shoes.data" :key="shoe.id" 
            ...
            <svg @click="getSpecifics('specifics')" width="40px" x="0px" y="0px"
              ...
              <path fill="#8697CB;" d="M15.918,33.561c-0.317,0.009-0.644,0.016-0.979,0.018c-0.552,0.003-0.997,0.453-0.994,1.006
              ...
              <path fill="#8697CB;" d="M27.73,32.119c-0.335,0.041-0.669,0.086-1.003,0.131c-0.547,0.075-0.931,0.579-0.856,1.126
              ...
              <path fill="#8697CB;" d="M12.024,33.473c-0.32-0.024-0.643-0.054-0.966-0.089c-0.546-0.06-1.042,0.337-1.102,0.887
              ...
              <path fill="#8697CB;" d="M1.048,31.238c0.216,0,0.435-0.07,0.617-0.214c0.435-0.342,0.509-0.971,0.168-1.404
              ...
              <path fill="#8697CB;" d="M8.204,32.925c-0.313-0.069-0.623-0.145-0.929-0.227c-0.532-0.144-1.081,0.173-1.225,0.707
              ...
              <path fill="#8697CB;" d="M4.634,31.739c-0.278-0.134-0.547-0.276-0.804-0.43c-0.475-0.282-1.088-0.127-1.371,0.348
              ...
              <path fill="#8697CB;" d="M23.741,32.675l-0.983,0.145c-0.547,0.079-0.926,0.586-0.846,1.133
              ...
              <path fill="#8697CB;" d="M47.713,33.589c-0.312-0.014-0.627-0.038-0.944-0.069c-0.571-0.055-1.04,0.349-1.094,0.896
              ...
              <path fill="#8697CB;" d="M51.301,33.207c-0.271,0.092-0.552,0.165-0.842,0.223c-0.541,0.108-0.893,0.635-0.784,1.177
              ...
              <path fill="#8697CB;" d="M55.269,30.928c-0.463-0.298-1.084-0.164-1.382,0.3c-0.152,0.236-0.321,0.457-0.505,0.657
              ...
              <path fill="#8697CB;" d="M54.909,28.509c-0.017,0.092-0.036,0.182-0.056,0.27c-0.121,0.538,0.217,1.074,0.756,1.195
              ...
              <path fill="#8697CB;" d="M35.895,31.669l-0.304-0.014c-0.249-0.009-0.498-0.015-0.748-0.018
              ...
              <path fill="#8697CB;" d="M31.766,31.72c-0.338,0.023-0.675,0.048-1.012,0.075c-0.551,0.046-0.96,0.528-0.915,1.079
              ...
              <path fill="#8697CB;" d="M39.983,32.288c-0.338-0.068-0.669-0.135-0.996-0.195c-0.541-0.101-1.065,0.255-1.167,0.798
              ...
              <path fill=":#8697CB;" d="M43.889,33.091c-0.323-0.062-0.647-0.125-0.971-0.189c-0.548-0.114-1.069,0.243-1.177,0.784
              ...
              <path class="svg__body" fill="#38454F;" d="M55.83,29.998c-0.073,0-0.146-0.008-0.221-0.024c-0.539-0.121-0.877-0.657-0.756-1.195
              ...
              <path fill="#ECF0F1;" d="M31.28,28.316c0.197,0.214,0.466,0.322,0.735,0.322c0.243,0,0.485-0.088,0.678-0.265
                ...
                L31.28,28.316z"/>
              <path fill="#ECF0F1;" d="M26.308,29.345c0.195,0.195,0.451,0.293,0.707,0.293s0.512-0.098,0.707-0.293
                c0.391-0.391,0.391-1.023,0-1.414l-4.268-4.268c-0.583,0.314-1.195,0.619-1.821,0.919c0.047,0.093,0.097,0.185,0.174,0.263
                L26.308,29.345z"/>
              <path fill="#ECF0F1;" d="M21.308,30.345c0.195,0.195,0.451,0.293,0.707,0.293s0.512-0.098,0.707-0.293
