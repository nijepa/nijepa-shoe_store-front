<template>
  <div class="search__container">
    <svg @click="focusSearch" width="40px" x="0px" y="0px"
        viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
      <path class="svg__body" fill="#507C5C;" d="M317.256,389.35c-49.876,0-99.736-18.979-137.706-56.947c-5.734-5.734-5.734-15.032,0-20.767
      ...
      <path fill="#CFF09E;" d="M232.967,278.987c-46.477-46.477-46.477-122.1,0-168.577s122.1-46.477,168.577,0
        s46.477,122.1,0,168.577S279.444,325.463,232.967,278.987z"/>

        <path class="svg__body" fill="#507C5C;" d="M317.256,328.528c-35.799,0-69.42-13.907-94.671-39.158c-25.251-25.251-39.158-58.872-39.158-94.671
        ...
        <path class="svg__body" fill="#507C5C;" d="M153.219,373.418c-3.758,0-7.515-1.435-10.383-4.301c-5.734-5.734-5.735-15.032,0-20.767
        ...
        <path class="svg__body" fill="#507C5C;" d="M58.011,511.954c-3.758,0-7.515-1.435-10.383-4.301L4.301,464.326
    ...
    <input @keyup="queryItems" 
            v-model="searchStr" 
            type="text" 
            name="search" 
            id="search"
            ref="search">
    <select @change="queryItems" 
            v-model="pageNr"  
            name="pages" 
            id="pages">
...
<script>
  export default {
    ...
    data() {
      return {
        searchStr: this.strSearch,
        pageNr: Number(this.nrPages),
        queryOptions: {}
      }
    },
    ...
    methods: {
      ...
      queryItems() {
        this.queryOptions.nr = Number(this.pageNr);
        this.queryOptions.searchStr = this.searchStr;
        this.$emit('items-searched', this.queryOptions);
      }
    }
  }
</script>
